...
int test_current_date_to_string()
{
    int num_errors = 0;
    Date d = Date("2000-03-01");
    d.subtract_days(2);
    if (d.current_date_to_string().compare("2000-02-28") != 0) {
        num_errors++;
        cout << d << endl;
    }
    d = Date("2001-12-31");
    d.add_days(366);
    if (d.current_date_to_string().compare("2003-01-01") != 0) {
        num_errors++;
        cout << d << endl;
    }
    return num_errors;
...
int main()
{
    ...
    num_errors += test_current_date_to_string();
